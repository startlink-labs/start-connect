...
function FileTransfer() {
  ...
  const [salesforceProperties, setSalesforceProperties] =
    useState<SalesforceProperty>({});
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setContentVersionFolderPath(e.target.value)
                    }
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleMappingChange(group.prefix, value)
                            }
                          >
